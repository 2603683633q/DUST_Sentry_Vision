...
static rosidl_typesupport_introspection_c__MessageMember vision_msg__msg__GimblePosition__rosidl_typesupport_introspection_c__GimblePosition_message_member_array[4] = {
  {
    "time_stamp",  // name
