...
static const _Autoaim_type_support_symbol_names_t _Autoaim_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, global_interface, msg, Autoaim)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, global_interface, msg, Autoaim)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, global_interface, msg, Autoaim)() {
  return &::global_interface::msg::rosidl_typesupport_c::Autoaim_message_type_support_handle;
}
