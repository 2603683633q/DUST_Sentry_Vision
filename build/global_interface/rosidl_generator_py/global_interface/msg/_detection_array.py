    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'global_interface.msg.DetectionArray')
            logger.debug(
            ...
            from global_interface.msg import Detection
...
class DetectionArray(metaclass=Metaclass_DetectionArray):
    ...
    _fields_and_field_types = {
        ...
        'detections': 'sequence<global_interface/Detection>',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['std_msgs', 'msg'], 'Header'),  # noqa: E501
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['global_interface', 'msg'], 'Detection')),  # noqa: E501
    )
