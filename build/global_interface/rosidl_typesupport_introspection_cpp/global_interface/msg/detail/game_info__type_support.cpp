...
{
  new (message_memory) global_interface::msg::GameInfo(_init);
}

void GameInfo_fini_function(void * message_memory)
{
  auto typed_message = static_cast<global_interface::msg::GameInfo *>(message_memory);
  typed_message->~GameInfo();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember GameInfo_message_member_array[3] = {
  {
    "header",  // name
    ...
    offsetof(global_interface::msg::GameInfo, header),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(global_interface::msg::GameInfo, timestamp),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(global_interface::msg::GameInfo, game_stage),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers GameInfo_message_members = {
  ...
  3,  // number of fields
  sizeof(global_interface::msg::GameInfo),
...
{
  return &::global_interface::msg::rosidl_typesupport_introspection_cpp::GameInfo_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, global_interface, msg, GameInfo)() {
  return &::global_interface::msg::rosidl_typesupport_introspection_cpp::GameInfo_message_type_support_handle;
}
