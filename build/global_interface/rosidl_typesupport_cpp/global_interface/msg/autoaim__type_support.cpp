...
static const _Autoaim_type_support_symbol_names_t _Autoaim_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, global_interface, msg, Autoaim)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, global_interface, msg, Autoaim)),
  }
};
...
{
  return &::global_interface::msg::rosidl_typesupport_cpp::Autoaim_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, global_interface, msg, Autoaim)() {
  return get_message_type_support_handle<global_interface::msg::Autoaim>();
}
