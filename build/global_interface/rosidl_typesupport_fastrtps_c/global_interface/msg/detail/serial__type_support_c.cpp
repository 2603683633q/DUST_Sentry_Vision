...
#include "global_interface/msg/detail/serial__rosidl_typesupport_fastrtps_c.h"
...
using _Serial__ros_msg_type = global_interface__msg__Serial;
...
size_t get_serialized_size_global_interface__msg__Serial(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Serial__ros_msg_type * ros_message = static_cast<const _Serial__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _Serial__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_global_interface__msg__Serial(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_global_interface
size_t max_serialized_size_global_interface__msg__Serial(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = global_interface__msg__Serial;
    is_plain =
      (
...
static size_t _Serial__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_global_interface__msg__Serial(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, global_interface, msg, Serial)() {
