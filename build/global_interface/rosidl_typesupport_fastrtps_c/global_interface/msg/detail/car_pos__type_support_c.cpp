...
#include "global_interface/msg/detail/car_pos__rosidl_typesupport_fastrtps_c.h"
...
#include "global_interface/msg/detail/point2f__functions.h"  // pos
...
using _CarPos__ros_msg_type = global_interface__msg__CarPos;
...
size_t get_serialized_size_global_interface__msg__CarPos(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _CarPos__ros_msg_type * ros_message = static_cast<const _CarPos__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _CarPos__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_global_interface__msg__CarPos(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_global_interface
size_t max_serialized_size_global_interface__msg__CarPos(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = global_interface__msg__CarPos;
    is_plain =
      (
...
static size_t _CarPos__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_global_interface__msg__CarPos(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, global_interface, msg, CarPos)() {
