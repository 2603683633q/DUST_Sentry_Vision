...
#include "global_interface/msg/detail/detection__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const global_interface::msg::Detection & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  global_interface::msg::Detection & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = global_interface::msg::Detection;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const global_interface::msg::Detection *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<global_interface::msg::Detection *>(
    untyped_ros_message);
...
{
  return &global_interface::msg::typesupport_fastrtps_cpp::_Detection__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, global_interface, msg, Detection)() {
  return &global_interface::msg::typesupport_fastrtps_cpp::_Detection__handle;
}
