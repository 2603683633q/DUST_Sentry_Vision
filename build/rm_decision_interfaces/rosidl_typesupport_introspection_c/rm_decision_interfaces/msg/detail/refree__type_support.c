...
static rosidl_typesupport_introspection_c__MessageMember rm_decision_interfaces__msg__Refree__rosidl_typesupport_introspection_c__Refree_message_member_array[3] = {
  {
    "robot_hp",  // name
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rm_decision_interfaces__msg__Refree, base_hp),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rm_decision_interfaces__msg__Refree, color),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
